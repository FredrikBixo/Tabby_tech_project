...
public class CrashingGameActivity extends AppCompatActivity implements SensorEventListener {
        ...
        alertEscapeTask = new TimerTask() {
            public void run() {
                handler.post(new Runnable() {
                    public void run() {
                        AlertDialog.Builder builder = new AlertDialog.Builder(CrashingGameActivity.this);
                        builder.setTitle("Oh no...")
                                ...
                                .setPositiveButton("Return to game", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        Intent intent = new Intent(CrashingGameActivity.this, HelloArActivity.class);
            ...
            public void run() {
                handler.post(new Runnable() {
                    public void run() {
                        ...
                        if(isAccelerometerAvailable)
                            sensorManager.registerListener((SensorEventListener) CrashingGameActivity.this, accelerometerSensor, SensorManager.SENSOR_DELAY_NORMAL);
                        sensorManager.registerListener(gyroscopeEventListener, gyroscopeSensor, SensorManager.SENSOR_DELAY_FASTEST);
...
//Accelerometer methods
        ...
        zTextView.setText(Math.round(sensorEvent.values[2] * 100.0) / 100.0 + " m/s² ");*/
            ...
            if (itIsNotFirstTime) {
                ...
                if ((xDifference > shakeThreshHold && yDifference > shakeThreshHold) ||
                    ...
                    MediaPlayer ring = MediaPlayer.create(CrashingGameActivity.this, R.raw.woosh);
                    ring.start();
    ...
    private void placeButterfly() {
        ...
        butterfly.layout(X - butterflySize/2, Y - butterflySize/2, X + butterflySize/2,
                Y + butterflySize/2);
    }
